...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bill.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILL_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILL actions', async () => {
      const expectedActions = [
        {
