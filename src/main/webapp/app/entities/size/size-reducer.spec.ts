...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './size.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIZE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SIZE actions', async () => {
      const expectedActions = [
        {
