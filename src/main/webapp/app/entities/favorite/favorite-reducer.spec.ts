...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './favorite.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAVORITE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAVORITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAVORITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAVORITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAVORITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAVORITE actions', async () => {
      const expectedActions = [
        {
